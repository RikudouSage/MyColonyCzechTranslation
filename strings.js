(function (window, document) {
    window.appStrings = {
        "cs": {
            ...
            "uraniumminer-description": "Těží z Uranových dolů a převáží radioaktivní materiál zpět do jaderné elektrárny.",
            "nuclearplant-description": "Rafinuje surový Uran a používá jej pro výrobu elektřiny pro vaši kolonii.",
            "bacteriafarm-description": "Začněte rozmnožovat bakteriální žvotní formy, které budou zhušťovat atmosféru pro vaši kolonii.",
            "greenbot-description": "Užitečné malé stavící vozítko, které umí stavět budovy související se zemědělstvím.",
            "firtrees-description": "Tyto vznosné jedle rostou skvěle i v řídké atmosféře. Mohou být využity jako dekorace nebo zdroj dřeva.",
            "engine-keyboard": "Klávesové zkratky",
            "engine-keyboard-meta": "Změňte nastavení klávesových zkratek ve hře.",
            "general-cancel": "Zrušit",
            "keyboard-clear-menus": "Smazat aktivní dialogy",
            "keyboard-idle-unit": "Najít nevyužité vozidlo",
            "keyboard-sell-noconf": "Prodávat budovy bez potvrzení",
            "hold-and-click-tip": "Držte kombinaci kláves a zvolte budovu.",
            "keyboard-upgrade-noconf": "Zvyšovat úroveň budov bez potvrzení",
            "when-object-selected": "Aktivní, když je vybrán objekt",
            "keyboard-move-unit": "Přesunout aktivní jednotku",
            "keyboard-harvest-mode": "Aktivovat těžící mód",
            "keyboard-show-build": "Zobrazit možnost budovy",
            "keyboard-show-export": "Zobrazit možnosti exportu",
            "keyboard-show-import": "Zobrazit možnosti importu",
            "keyboard-sell": "Prodat aktivní objekt",
            "keyboard-upgrade": "Povýšit aktivní objekt",
            "keyboard-defaults": "Obnovit výchozí",
            "keyboard-defaults-warn": "Smaže všechna vlastní nastavení!",
            "keyboard-cancel-nocon": "Rušit stavění bez potvrzení",
            "keyboard-cancel": "Zrušit stavění",
            "general-move": "Přesunout",
            "general-harvest": "Těžit",
            "general-build": "Postavit",
            "general-upgrade": "Povýšit",
            "general-import": "Importovat",
            "general-export": "Exportovat",
            "general-dismiss": "Skrýt",
            "medicalclinic-description": "Poskytuje kolonistům služby na zlepšení zdraví.",
            "general-park-unit": "Zaparkovat",
            "general-park-confirm": "Parkovací místo zvoleno",
            "engine-sidebar": "Postranní panel",
            "tax-window-trade-embargo": "Kvůli opakované neschopnosti platit daně lidem z #motherland se valná hromada #motherland rozhodla uvalit obchodní embargo na vaši kolonii!",
            "tax-window-lift-embargo": "Valná hromada #motherland s radostí zrušila obchodní embargo vůči vaší kolonii.",
            "tax-window-img-embargo": "Kvůli ochlazujícím se vztahům mezi vaší kolonií a lidmi z #motherland se valná hromada #motherland rozhodla přijmout v platnost zákaz imigrace do vaší kolonie!",
            "tax-window-img-lift": "Valná hromada #motherland s radostí obnovila imigraci do vaší kolonie.",
            "wall-description": "Obalte zdmi oblasti pro dekoraci nebo pro navádění provozu robotů.",
            "lumbermill-description": "Poráží stromy na Dřevo.",
            "lumberbot-description": "Tenhle užitečný sběrač umí stromy nejen porážet, ale i zasazovat nové!",
            "sfhouse-description": "Vezměte ženu a děti a přestěhujte se do tohoto nostalgického rodinného domu!",
            "megabot-description": "Pořádný stavitel, který se nebojí ani těch největších projektů.",
            "urenrich-description": "Ukázka geniálního spojení vědy a techniky - tato budova umožňuje zdvojnásobit sílu Uranu. Vyžaduje hodně energie a stálý přísun Hliníku.",
            "lgwatertower-description": "Obří vodní věž, která udrží tuny vody. Co víc k tomu říct?",
            "largeres-description": "Velmi nahuštěná obydlí. Nic moc luxusního, ale levně ubytuje spoustu lidí.",
            "indepence-noafford": "Nemůžete si dovolit nezávislost na #motherland.",
            "independence-general": "Nezávislost",
            "general-united-earth": "Spojená Země",
            "relations-header": "Vztahy s #motherland",
            "foundation-header": "Založeno",
            "foundation-charter": "Jako leník #motherland dne",
            "independence-ask": "Přejete si vyhlásit nezávislost na #motherland za #cost?",
            "general-nevermind": "Někdy příště",
            "independence-declare": "Vyhlásit",
            "independence-final": "Vyhlásili jsme nezávislost na #motherland dne #independenceday!",
            "independence-stat": "Od #motherland dne",
            "selfgov-desc": "Naučte se metody a postupy pro vytvoření vlastní nezávislé vlády.",
            "capitol-description": "Postavte pro váš nový nezávislý stát ohromující kongresní budovu!",
            "subtfood-description": "Hlubinné zařízení s kontrolovaným klimatem, které skladuje velké množství jídla.",
            "empire-general": "Společenství",
            "engine-zoom-buttons": "Zobrazit přibližovací tlačítka",
            "lgcons-desc": "Objevte tajemství opravdu velkých budov v nízkogravitačním prostředí!",
            "treefarm-description": "Sází a poráží stromy pro dřevorubce.",
            "aluminumminer-description": "Robustní a přátelský robot, který těží z ložisek Hliníku.",
            "new-game-charter": "Kód lenního pána (nepovinné)",
            "charter-warning": "Započetí nové hry s lenním pánem importuje nějaká uživatelem vytvořená data, která nebyla zkontrolována Ape Apps. Mohlo by se například jednat o nevhodnou mluvu. Opravdu chcete začít novou hru s tímto lenním pánem?",
            "general-charter": "Lenní pán",
            "general-yes": "Ano",
            "general-no": "Ne",
            "charter-info": "Můžete svůj lenní kód sdílet s přáteli a oni pak mohou začít novou hru jako vaši leníci. Budete mít příjem z daní, které zaplatí a můžete obchodovat s hráči, kteří jsou vaši leníci. Váš lenní kód je #charterid",
            "charter-share": "Zahrejte si My Colony s lenním kódem: #charterid #appurl",
            "general-share": "Sdílet",
            "charter-settings-desc": "Sdílejte svůj lenní kód a rozšiřte své společenství!",
